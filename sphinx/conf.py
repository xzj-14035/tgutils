...
latex_documents = [
    (master_doc, 'TGUtils.tex', 'TGUtils Documentation',
...
man_pages = [
    (master_doc, 'tgutils', 'TGUtils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TGUtils', 'TGUtils Documentation',
     author, 'TGUtils', 'One line description of project.',
     'Miscellaneous'),
]

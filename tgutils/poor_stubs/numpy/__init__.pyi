...
class ndarray(ArrayLike):
    ...
    def setflags(self, **kwargs: Any) -> None: ...
...
def absolute(a: ndarray, **kwargs: Any) -> ndarray: ...
...
def asscalar(v: Any) -> Union[float, int]: ...
...
def copyto(a: ndarray, b: ndarray) -> None: ...
...
def matmul(a: ndarray, b: ndarray, **kwargs: Any) -> None: ...
...
def nanmin(a: Union[ndarray, List[ndarray]], *args: Any, **kwargs: Any) -> Any: ...


def nanmean(a: Union[ndarray, List[ndarray]], *args: Any, **kwargs: Any) -> Any: ...
...
def resize(a: ndarray, *args: Any, **kwargs: Any) -> ndarray: ...
